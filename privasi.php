...
$query = "SELECT * FROM pages WHERE slug = 'kebijakan-privasi'";
$result = mysqli_query($conn, $query);
$page = mysqli_fetch_assoc($result);

// Default jika belum ada di database
$konten = $page ? $page['isi'] : "<div class='text-center py-20'><h2>Belum Ada Konten</h2><p>Silakan isi 'Kebijakan Privasi' di Admin Panel.</p></div>";
?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-gray-800 px-8 py-6">
                <h1 class="text-2xl font-bold text-white">
                    <?php echo $page ? htmlspecialchars($page['judul']) : 'Kebijakan Privasi'; ?>
                </h1>
